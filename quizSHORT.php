...
<body>
	<div class ="container">
			...
			<form action="post_SHORT_quiz.php" method="post" id="quiz">
				<fieldset>
				<div id="1">
 	...
 	<!-- -->			<div id="4" class="hide">
 				...
 				<div id="6" class="hide">
				    <h4>Q6. The rich should be taxed at a higher rate than the middle class or poor.</h4>
				   	<div class="btn-group"  data-toggle="buttons-radio">
 					 	...
 					 	<button type="button" value="60" class="btn btn-large btn-block" name="6"><?php echo $disagree_text ?></button>
 					 	<button type="button" value="85" class="btn btn-large btn-block" name="6"><?php echo $strongly_disagree_text ?></button>
...
<div id="8" class="hide">
				    <h4>Q8. Access to healthcare is a right.</h4>
				   	<div class="btn-group"  data-toggle="buttons-radio">
 					 	<button type="button" value="0" class="btn btn-large btn-block" name="8"><?php echo $strongly_agree_text ?></button>
 					 	<button type="button" value="20" class="btn btn-large btn-block" name="8"><?php echo $agree_text ?></button>
 					 	<button type="button" value="50" class="btn btn-large btn-block" name="8"><?php echo $neutral_text ?></button>
 					 	<button type="button" value="80" class="btn btn-large btn-block" name="8"><?php echo $disagree_text ?></button>
 					 	<button type="button" value="100" class="btn btn-large btn-block" name="8"><?php echo $strongly_disagree_text ?></button>
...
<div id="10" class="hide">
				    <h4>Q10. Protectionism is sometimes necessary in trade.</h4>
				   	<div class="btn-group"  data-toggle="buttons-radio">
 					 	<button type="button" value="100" class="btn btn-large btn-block" name="10"><?php echo $strongly_agree_text ?></button>
 					 	<button type="button" value="60" class="btn btn-large btn-block" name="10"><?php echo $agree_text ?></button>
 					 	<button type="button" value="50" class="btn btn-large btn-block" name="10"><?php echo $neutral_text ?></button>
 					 	<button type="button" value="40" class="btn btn-large btn-block" name="10"><?php echo $disagree_text ?></button>
 					 	<button type="button" value="0" class="btn btn-large btn-block" name="10"><?php echo $strongly_disagree_text ?></button>
